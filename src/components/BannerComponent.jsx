                ...
                <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            <h1 className="heading text-4xl sm:text-5xl lg:text-6xl font-bold">
                                Hello,<br />
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="social-icon text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-[#00FF9D] transition-colors">
                                <Github size={24} />
                            </a>
                            <a href="#" className="social-icon text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-[#00FF9D] transition-colors">
                                <Linkedin size={24} />
                        ...
                        <div className="flex gap-4 pt-4">
                            <button className="button px-6 py-2 bg-transparent border border-green-600 dark:border-[#00FF9D] text-green-600 dark:text-[#00FF9D] hover:bg-green-600 dark:hover:bg-[#00FF9D] hover:text-white dark:hover:text-black transition-colors rounded flex items-center">
                                <Mail className="mr-2" size={18} /> CONTACT ME
                            </button>
                            <button className="button px-6 py-2 bg-pink-600 dark:bg-[#FF26B9] hover:bg-pink-700 dark:hover:bg-[#FF26B9]/90 text-white transition-colors rounded flex items-center">
                                <FileText className="mr-2" size={18} /> GET RESUME
                            </button>
                        </div>
                    </div>
                    <div className="w-full">
                        <pre className="code-block p-4 rounded-lg text-green-600 dark:text-[#00FF9D] font-mono text-sm sm:text-base overflow-x-auto shadow-md break-words whitespace-pre-wrap">
                            {`const coder = {
  name: '${coder.name}',
